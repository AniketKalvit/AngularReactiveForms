...
// code with FormBuilder service
constructor(private fb:FormBuilder){}
// FormGroup is used to create or manage child elements and its validations
// if any form control fails the validation FormGroup will not be submitted
